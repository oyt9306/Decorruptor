...
def get_ab(beta):
  if np.random.random() < 0.5:
    ...
    b = np.float32(np.random.beta(1, beta)) #.clip(0,0.8)
  else:
...
# def get_ab(beta):
#   # if np.random.random() < 0.5:
#   a = np.float32(np.random.beta(beta, 2))
#   b = np.float32(np.random.beta(2 , beta))
#   print(a,b)
#   # else:
#   #     a = 1 + np.float32(np.random.beta(5, beta))
#   #     b = -np.float32(np.random.beta(5, beta))
#   return a, b
